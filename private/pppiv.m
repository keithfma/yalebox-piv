...
%   Notes
%   -----
%   1) Several Matlab functions available <a
...
%   SMOOTHN, DCTN, IDCTN
%   2) Updated versions of PPPIV are available here: <a
...
%   See also SMOOTHN
%
%   -- Damien Garcia -- 2009/10, revised 2010/10
%   -- Website: <a
%   href="matlab:web('http://www.biomecardio.com')">www.BiomeCardio.com</a>
...
if s<0.1 % "no smoothing" option
    ...
    V = smoothn(V,s,'robust','TolZ',1e-4,'MaxIter',200,'Initial',V); 
else

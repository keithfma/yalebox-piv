...
data_top_dir=/projectnb/glaciermod/yalebox-exp-fault/data/fault_ss_01/piv
...
whos
util_setup_env();
piv_series('$output_file', '$input_file', samplen, sampspc, intrlen, npass, valid_max, valid_eps, lowess_span_pts, spline_tension, min_frac_data, min_frac_overlap, 1);
exit
EOF

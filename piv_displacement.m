...
if verbose
    ...
    fprintf('piv_displacement: found %d (%.1f%%), skipped %d (%.1f%%), dropped %d (%.1f%%)\n', ...
        num_found, num_found/num_total*100, num_skipped, num_skipped/num_total*100, ...
        num_dropped, num_dropped/num_total*100);
end
...
out_file = {'030_031_eqlN_cbcY.mat', '250_251_eqlN_cbcY.mat'};
out_fig = {'uv_eqlN_cbcY.fig', 'dd_eqlN_cbcY.fig'};
fig_name = {'displacement: eqlN_cbcY', 'strain: eqlN_cbcY'};

...
%   grid: 'm' points of dimension 'd' over which pdf is computed; default
%       provided only for 2-dimensional data; see example on how to construct it
%       in higher dimensions
%   gam: cost/accuracy tradeoff parameter, where gam<n; default value is
%       gam=ceil(n^(1/2)); larger values may result in better accuracy, but
%       always reduce speed; to speedup the code, reduce the value of "gam";
%   verbose: set true to print "verbose" progress messages, default is false
...
%       isosurface(X1, X2, X3, pdf, iso);
%       view(3), alpha(.3), box on, hold on, colormap cool
%   end
%
% Reference:
%
%   Kernel density estimation via diffusion. Z. I. Botev, J. F. Grotowski, and
%   D. P. Kroese (2010). Annals of Statistics, Volume 38, Number 5, pages
%   2916-2957.
%
% Notes:
%   + Minor edits by Keith Ma 29.11.2017. Improved code formatting and silence

function [] = yalebox_piv(input_file, output_file, npass, win, spc, ...
...
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv:input_file', input_file);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv:input_file:sha256sum', in.chksum);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:npass', npass);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:win:pixels', win);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:spc:pixels', spc);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:max_u_pos:pixels', max_u_pos);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:max_u_neg:pixels', max_u_neg);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:max_v_pos:pixels', max_v_pos);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:max_v_neg:pixels', max_v_neg);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:validate', double(validate));
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:eps_0', eps_0);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:eps_thresh', eps_thresh);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:min_sand_frac', min_sand_frac);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv:intra_pair_step', intra_pair_step);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv:inter_pair_step', inter_pair_step);
netcdf.putAtt(out.ncid, netcdf.getConstant('GLOBAL'),...
    'yalebox_piv_step:view', view);

% get image pair indices
nim = length(in.s);

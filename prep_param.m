...
%% grayscale, pad, and fill -- edit param file to update
...
[img_fill] = prep_fill(...
    img_pad, ...
    mask_pad, ...
    param.fill_skin_min.value, ...
    param.fill_skin_max.value, ...
    param.fill_bnd_smooth_window.value, ...
    param.fill_mirror.value, ...
    true);

%% equalize histogram -- edit param file to update

% FIXME 1111: called incorrectly, how do I make this mimic the call in the real processing pipeline?

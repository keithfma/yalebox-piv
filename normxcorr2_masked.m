...
validateattributes(fixedImage,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'fixedImage',1)
validateattributes(movingImage,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'movingImage',2)
validateattributes(fixedMask,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'fixedMask',3)
validateattributes(movingMask,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'movingMask',4)

...
% iptchecknargin(4,4,nargin,mfilename) % deprecated
narginchk(4,4);
...
% iptcheckinput(fixedImage,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'fixedImage',1) % deprecated
validateattributes(fixedImage, classes, attributes, mfilename, 'fixedImage');
% iptcheckinput(movingImage,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'movingImage',2) % deprecated
validateattributes(movingImage, classes, attributes, mfilename, 'movingImage');
% iptcheckinput(fixedMask,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'fixedMask',3) % deprecated
validateattributes(fixedMask, classes, attributes, mfilename, 'fixedMask');
% iptcheckinput(movingMask,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'movingMask',4) % deprecated

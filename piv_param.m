...
%       variables therein to suit your experiment.p
% 
...
ini      = image_data.img_ext(:, :, TEST_INDEX);
ini_mask = image_data.mask_ext(:, :, TEST_INDEX);

fin      = image_data.img_ext(:, :, TEST_INDEX + param.gap.value);
fin_mask = image_data.mask_ext(:, :, TEST_INDEX + param.gap.value);
...
display_strain(strain_result, piv_result.mask);
